...
Milestone v1.3 hardened Scriven's trust surface. It closed the gap between what the product claimed and what the repo could prove by aligning shipped assets, runtime policy, packaged proof artifacts, and release-time regression checks around the product's strongest differentiator: voice preservation.
