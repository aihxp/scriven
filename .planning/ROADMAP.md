...
<details>
<summary>✅ v1.7 Last Mile (Phases 29-35) — SHIPPED 2026-04-17</summary>

- [x] **Phase 29: Architectural Foundation** - `templates/sacred/` + `templates/platforms/` directories and `tradition:` / `platform:` spec keys (completed 2026-04-17)
- [x] **Phase 30: Export Cleanup & Validation Gate** - `/scr:cleanup` scaffold-stripping and `/scr:validate` pre-flight gate (completed 2026-04-17)
- [x] **Phase 31: Staged Front-Matter Generation** - Auto-computable front matter regenerates on metadata change; personalization elements ship as explicit scaffolds (completed 2026-04-17)
- [x] **Phase 32: Build Pipelines & Platform Awareness** - `/scr:build-ebook` + `/scr:build-print` with per-platform trim/page guardrails (completed 2026-04-17)
- [x] **Phase 33: Sacred Tradition Profiles** - Ten tradition profiles with approval blocks, font stacks, RTL, and numbering macros (completed 2026-04-17)
- [x] **Phase 34: Cross-Domain Narrative & Poetry Templates** - Stage play, picture book, fixed-layout EPUB, Smashwords DOCX, chapbook, poetry-submission templates (completed 2026-04-17)
- [x] **Phase 35: Academic LaTeX Wrappers** - Thin IEEE / ACM / LNCS / Elsevier / APA7 wrappers referencing user-installed publisher classes (completed 2026-04-17)
