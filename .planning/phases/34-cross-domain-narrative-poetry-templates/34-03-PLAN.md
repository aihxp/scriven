...
must_haves:
  truths:
    ...
    - "A Smashwords writer gets a Pandoc-generated DOCX using scriven-smashwords.docx reference doc"
  ...
  artifacts:
    - path: "data/export-templates/scriven-chapbook.typst"
      provides: "5.5x8.5 chapbook PDF template with saddle-stitch page count logic"
      contains: "5.5in"
    - path: "data/export-templates/scriven-smashwords.docx"
      provides: "Pandoc reference DOCX for Smashwords Style Guide compliance"
    - path: "data/export-templates/scriven-smashwords-styles.md"
      provides: "Style guide documentation for Smashwords DOCX styles"
      contains: "no tabs"
    - path: "data/export-templates/scriven-poetry-submission.docx"
      provides: "Pandoc reference DOCX for poetry submission manuscripts"
    - path: "data/export-templates/scriven-poetry-submission-styles.md"
  ...
  key_links:
    - from: "commands/scr/build-smashwords.md"
      to: "data/export-templates/scriven-smashwords.docx"
      via: "pandoc --reference-doc=data/export-templates/scriven-smashwords.docx"
      pattern: "scriven-smashwords.docx"
    - from: "commands/scr/build-poetry-submission.md"
      to: "data/export-templates/scriven-poetry-submission.docx"
      via: "pandoc --reference-doc=data/export-templates/scriven-poetry-submission.docx"
      pattern: "scriven-poetry-submission.docx"
---
...
<task type="auto" tdd="true">
  <name>Task 1: Create scriven-chapbook.typst and both DOCX reference docs + style spec files</name>
  <files>
    data/export-templates/scriven-chapbook.typst
    data/export-templates/scriven-smashwords.docx
    data/export-templates/scriven-smashwords-styles.md
  ...
  <action>
    ...
    //
    // Usage: pandoc ... --pdf-engine=typst --template=data/export-templates/scriven-chapbook.typst
    ...
    Create data/export-templates/scriven-smashwords.docx:

    Generate the Pandoc default reference DOCX using:
    ```bash
    cd /Users/hprincivil/Projects/scriven
    ...
    and document it in scriven-smashwords-styles.md so the executor knows to regenerate it:
    ```bash
    touch data/export-templates/scriven-smashwords.docx
    ```
    ...
    Create data/export-templates/scriven-smashwords-styles.md:
    ...
    Create data/export-templates/scriven-poetry-submission.docx:
    ...
    ```bash
    touch data/export-templates/scriven-poetry-submission.docx
    ```

    ---

    Create data/export-templates/scriven-poetry-submission-styles.md:
  ...
  <verify>
    <automated>ls data/export-templates/scriven-chapbook.typst data/export-templates/scriven-smashwords.docx data/export-templates/scriven-smashwords-styles.md data/export-templates/scriven-poetry-submission.docx data/export-templates/scriven-poetry-submission-styles.md && grep "5.5in" data/export-templates/scriven-chapbook.typst && grep "no tabs" data/export-templates/scriven-smashwords-styles.md && grep "Times New Roman" data/export-templates/scriven-poetry-submission-styles.md</automated>
  </verify>
  <acceptance_criteria>
    - data/export-templates/scriven-chapbook.typst exists and contains "5.5in", "8.5in", "multiple of 4" or "saddle" or "mod 4"
    - data/export-templates/scriven-smashwords.docx exists (any size, including zero bytes)
    - data/export-templates/scriven-smashwords-styles.md exists and contains "no tabs" and "first-line" (or "FirstLineIndent")
    - data/export-templates/scriven-poetry-submission.docx exists (any size, including zero bytes)
    - data/export-templates/scriven-poetry-submission-styles.md exists and contains "page break" (or "pagebreak") and "Times New Roman"
    - Grep check: `grep "5.5in" data/export-templates/scriven-chapbook.typst` exits 0
    - Grep check: `grep "no tabs" data/export-templates/scriven-smashwords-styles.md` exits 0
  </acceptance_criteria>
</task>
...
<task type="auto" tdd="true">
  ...
  <acceptance_criteria>
    - commands/scr/build-smashwords.md exists and contains "--reference-doc" and "scriven-smashwords.docx"
    - commands/scr/build-poetry-submission.md exists and contains "title page" (or "title-page"), "TOC" (or "toc"), and "scriven-poetry-submission.docx"
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    Spot checks:
    1. Open data/export-templates/scriven-chapbook.typst — confirm 5.5in width, 8.5in height, "multiple of 4" or "saddle" comment
    2. Confirm data/export-templates/scriven-smashwords.docx exists (ls -la, any size including 0 bytes is fine)
    3. Open data/export-templates/scriven-smashwords-styles.md — confirm "no tabs" rule and first-line indent documentation
    4. Confirm data/export-templates/scriven-poetry-submission.docx exists
    5. Open data/export-templates/scriven-poetry-submission-styles.md — confirm "Times New Roman", "page break" per poem
