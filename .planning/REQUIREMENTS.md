...
- [ ] **DOC-02**: Getting Started guide — install to first draft in 10 minutes, covering `npx scriven@latest`, `/scr:new-work`, `/scr:discuss`, `/scr:draft`
...
| DOC-10 | Phase 10 | Pending |
| DOC-11 | Phase 10 | Pending |
